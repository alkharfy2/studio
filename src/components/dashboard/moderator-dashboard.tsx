...
export default function ModeratorDashboard({ user }: { user: User }) {
    ...
    <div className="flex flex-col gap-8">
      <div className="flex justify-between items-center">
        <div>
            ...
            <p className="text-muted-foreground">Welcome back, {user?.name || 'Moderator'}. Here's your performance overview.</p>
        </div>
        <Button>
          <PlusCircle />
